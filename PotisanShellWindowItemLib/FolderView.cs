...
public class FolderView(object? o) : ComUnknownWrapperBase<IFolderView>(o)
{
	...
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	public ComResult<ShellItemArray> AllItemsNoThrow => GetAllItemsNoThrow<ShellItemArray, IShellItemArray>();
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	public ComResult<ShellItemArray> SelectedItemsNoThrow => GetSelectedItemsNoThrow<ShellItemArray, IShellItemArray>();
	[DebuggerBrowsable(DebuggerBrowsableState.Never)]
	public ComResult<ShellItemArray> CheckedItemsNoThrow => GetCheckedItemsNoThrow<ShellItemArray, IShellItemArray>();

	public ShellItemArray AllItems => GetAllItems<ShellItemArray, IShellItemArray>();
	public ShellItemArray SelectedItems => GetSelectedItems<ShellItemArray, IShellItemArray>();
	public ShellItemArray CheckedItems => GetCheckedItems<ShellItemArray, IShellItemArray>();
	...
	public ComResult SelectAndPositionItemsNoThrow(SafeHandle[] pidls, (int X, int Y)[] positions, ShellViewSelectItemFlag flags)
	{
		...
		return new(_obj.SelectAndPositionItems((uint)pidls.Length, pidls.Select(h => h.DangerousGetHandle()).ToArray(),
			positions.Select(pt => new POINT { x = pt.X, y = pt.Y }).ToArray(), (uint)flags));
	}

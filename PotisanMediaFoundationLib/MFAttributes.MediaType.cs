...
public sealed partial class MFMediaTypeAttributes(MFAttributes attrs)
{
	...
	{
		get => Attributes.GetGuidWithDefault(MFMediaTypeAttributeGuids.MF_MT_MAJOR_TYPE);
		set => Attributes.SetGuidWithDefault(MFMediaTypeAttributeGuids.MF_MT_MAJOR_TYPE, value);
	}

	public Guid? SubType
	{
		get => Attributes.GetGuidWithDefault(MFMediaTypeAttributeGuids.MF_MT_SUBTYPE);
		set => Attributes.SetGuidWithDefault(MFMediaTypeAttributeGuids.MF_MT_SUBTYPE, value);
	}

	//public static Guid MF_MT_ALL_SAMPLES_INDEPENDENT => new(0xc9173739, 0x5e56, 0x461c, 0xb7, 0x13, 0x46, 0xfb, 0x99, 0x5c, 0xb9, 0x5f);

	public uint? FixedSizeSamples
	{
		get => Attributes.GetUInt32WithDefault(MFMediaTypeAttributeGuids.MF_MT_FIXED_SIZE_SAMPLES);
		set => Attributes.SetUInt32WithDefault(MFMediaTypeAttributeGuids.MF_MT_FIXED_SIZE_SAMPLES, value);
	}
	...
	{
		get => Attributes.GetUInt32WithDefault(MFMediaTypeAttributeGuids.MF_MT_SAMPLE_SIZE);
		set => Attributes.SetUInt32WithDefault(MFMediaTypeAttributeGuids.MF_MT_SAMPLE_SIZE, value);
	}
	...
	public ulong? FrameSizeRaw
	{
		get => Attributes.GetUInt64WithDefault(MFMediaTypeAttributeGuids.MF_MT_FRAME_SIZE);
		set => Attributes.SetUInt64WithDefault(MFMediaTypeAttributeGuids.MF_MT_FRAME_SIZE, value);
	}

	public (uint Width, uint Height)? FrameSize
	{
		get => FrameSizeRaw is { } x ? InternalUtil.GetUSizeFromUInt64(x) : null;
		set => FrameSizeRaw = value is { } x ? ((x.Width << 32) | x.Height) : null;
	}

	public ulong? FrameRateRaw
	{
		get => Attributes.GetUInt64WithDefault(MFMediaTypeAttributeGuids.MF_MT_FRAME_RATE);
		set => Attributes.SetUInt64WithDefault(MFMediaTypeAttributeGuids.MF_MT_FRAME_RATE, value);
	}

	public MFFrameRate? FrameRate
	{
		get => FrameRateRaw is { } x ? new(x) : null;
		set => FrameRateRaw = value is { } x ? x.ToUInt64() : null;
	}
	...
	public uint? NumberOfOutputBuffer
	{
		get => Attributes.GetUInt32WithDefault(MFMediaTypeAttributeGuids.MF_MT_OUTPUT_BUFFER_NUM);
		set => Attributes.SetUInt32WithDefault(MFMediaTypeAttributeGuids.MF_MT_OUTPUT_BUFFER_NUM, value);
	}
	...
	////
	///
	public uint? DefaultStride
	{
		get => Attributes.GetUInt32WithDefault(MFMediaTypeAttributeGuids.MF_MT_DEFAULT_STRIDE);
		set => Attributes.SetUInt32WithDefault(MFMediaTypeAttributeGuids.MF_MT_DEFAULT_STRIDE, value);
	}

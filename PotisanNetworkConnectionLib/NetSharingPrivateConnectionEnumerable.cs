...
/// <remarks><c>IEnumNetSharingPrivateConnection</c> COMインターフェイスのラッパーです。</remarks>
public sealed class NetSharingPrivateConnectionEnumerable(object? o) : ComUnknownWrapperBase<IEnumNetSharingPrivateConnection>(o), IEnumerable<NetConnection>, ICloneable
{
